                                            ...
                                            <div class="account__form">
                                                <form class="ej-company-create-form" data-user-key="<?php echo $_GET['user']?>" data-nonce="<?php echo wp_create_nonce('easyjobs_create_company_nonce')?>">
                                                    <div class="form-note mb-4">
                                                        <?php _e('Give us few more information about your company', 'easyjobs');?>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>
                                                            <?php _e('Company Name', 'easyjobs'); ?>*
                                                        </label>
                                                        <input class="form-control" type="text" placeholder="Your Company Name" name="name"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>
                                                            <?php _e('Username / Company', 'easyjobs'); ?>*
                                                        </label>
                                                        ...
                                                        <span class="text-capitalize">
                                                            <?php _e('tips', 'easyjobs');?>:
                                                        </span>
                                                            <?php _e('Accepted characters for username are alphabets, numbers, hyphen & underscore.', 'easyjobs');?>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>
                                                            <?php _e('Phone No', 'easyjobs');?>*
                                                        </label>
                                                        <input class="form-control" type="text" placeholder="0123456789" name="mobile_number"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>
                                                            <?php _e('Industry', 'easyjobs');?>*
                                                        </label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <span class="text-capitalize">
                                                            ...
                                                            <?php _e('Tips: Website URL should look like http://www.example.com', 'easyjobs');?>
                                                        </div>
                                                    </div>
                                                    <div class="row employeeNumber">
                                                        <label for="Category">
                                                            <?php _e('Number of Employees*', 'easyjobs'); ?>
                                                        </label>
                                                    ...
                                                    <label class="checkbox mt-3">
                                                        ...
                                                        <span>
                                                        <?php _e('I Agree to the Terms and Policy*', 'easyjobs')?>
                                                    </span>
                                                    </label>
                                                    <div class="d-flex justify-content-between equal-divided mt-3">
                                                        <button class="button info-button">
                                                            <?php _e('Get Started', 'easyjobs'); ?>
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <div class="basic__content__block">
                                            ...
                                            <div class="feature__list">
                                                ...
                                                <div class="feature__item feature__item--five">
                                                    <div class="icon">
                                                        <img src="<?php echo EASYJOBS_ADMIN_URL; ?>assets/img/icon-5.png" alt="">
                                                    </div>
                                                    <p>Custom Design</p>
                                                    <span class="isPro">pro</span>
                                                </div>
                                                <div class="feature__item feature__item--six">
                                                    <div class="icon">
                                                        <img src="<?php echo EASYJOBS_ADMIN_URL; ?>assets/img/icon-6.png" alt="">
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                                                            ...
                                                            <form class="ej-login-form" data-nonce="<?php echo wp_create_nonce('easyjobs_signin_nonce')?>">
                                                                ...
                                                                <div class="d-flex justify-content-between mt-4">
                                                                    ...
                                                                    <a href="<?php echo EASYJOBS_APP_URL;?>/forgot-password" target="_blank" class="forget-button">
                                                                        <?php _e('Forgot Password?', 'easyjobs');?>
                                                                    </a>
                                                                </div>
                                                            </form>
                                                        </div>
                                                        <div class="account__form connect-option api-key">
                                                            ...
                                                            <form class="ej-connect-form">
                                                                <div class="form-group">
                                                                    <label>
                                                                        <?php _e('Api key', 'easyjobs'); ?>
                                                                    </label>
                                                                    <input type="text" name="easyjobs_api_key" class="form-control" placeholder="<?php _e('Enter your api key', 'easyjobs');?>">
                                                        ...
                                                        <div class="company-select">
                                                            <form class="ej-company-select-form" data-nonce="<?php echo wp_create_nonce('easyjobs_company_select_nonce')?>">
                                                                <div class="form-group">
                                                                    <label>
                                                                        <?php _e('Select Company', 'easyjobs');?>
                                                                    </label>
                                                            ...
                                                            <form class="ej-signup-form" data-nonce="<?php echo wp_create_nonce('easyjobs_signup_nonce'); ?>">
                                                                <div class="d-flex w-100">
                                                                    <div class="pr-2 w-50">
                                                                        <div class="form-group">
                                                                            <label>
                                                                                <?php _e('First Name', 'easyjobs'); ?> *
                                                                            </label>
                                                                            <input class="form-control" type="text" placeholder="Your First Name" name="first_name" value="<?php echo !empty($user_data['first_name']) ? $user_data['first_name'] : '';?>"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="pl-2 w-50">
                                                                        <div class="form-group">
                                                                            <label>
                                                                                <?php _e('Last Name', 'easyjobs'); ?>*
                                                                            </label>
                                                                            <input class="form-control" type="text" placeholder="Your Last Name" name="last_name" value="<?php echo !empty($user_data['last_name']) ? $user_data['last_name'] : '';?>"/>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" placeholder="youremail@gmail.com" name="email" value="<?php echo !empty($user_data['email']) ? $user_data['email'] : '';?>"/>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>
                                                                        <?php _e('Password', 'easyjobs'); ?>*
                                                                    </label>
                                                                    <input class="form-control" type="password" placeholder="************" name="password" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>
                                                                        <?php _e('Confirm Password', 'easyjobs'); ?>*
                                                                    </label>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="ej-error-msg">
                            ...
                            <h4 class="ej-msg">
                                <?php _e('Api Connect Failed !!', 'easyjobs');?>
                            </h4>
                            <p>
                                <?php _e('Invalid api key', 'easyjobs');?>
                            </p>
                        </div>
                        <div class="ej-success-msg">
                            <i class="dashicons dashicons-yes-alt"></i>
                            <h4 class="ej-msg">
                                <?php _e('Api Connected Successfully !!', 'easyjobs');?>
                            </h4>
                        </div>
                    </div>
