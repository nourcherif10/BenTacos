    ...
    <div class="easyjobs-wrapper admin-area">
        <div class="page-header">
            ...
            <div class="tools ml-auto">
                <p class="mb-0"><?php _e('Version:', 'easyjobs' ); ?> <?php echo EASYJOBS_VERSION; ?></p>
            </div>
            <!--<div class="tools">
                        ...
                        <li class="nav-item">
                            ...
                            >
                                <span class="d-none d-sm-block">
                                    <?php _e('Published Jobs', 'easyjobs' ); ?>
                                </span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div role="tabpanel"
                            ...
                            <div class="bg-white mt-3">
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tr>
                                        <th>
                                            <?php _e('Title', 'easyjobs' ); ?>
                                        </th>
                                        <th>
                                            <?php _e('Candidates', 'easyjobs' ); ?>
                                        </th>
                                        <th>
                                            <?php _e('Department', 'easyjobs' ); ?>
                                        </th>
                                        <th>
                                            <?php _e('Expiry Date', 'easyjobs' ); ?>
                                        </th>
                                        <th>
                                            <?php _e('Action', 'easyjobs' ); ?>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item"
                                                               ...
                                                               target="_blank"><?php _e('Preview', 'easyjobs'); ?></a>
                                                            <a class="dropdown-item"
                                                               href="<?php echo admin_url('admin.php?page=easyjobs-admin&job-id=' . $job->id . '&view=pipeline'); ?>"><?php _e('Pipeline', 'easyjobs'); ?></a>
                                                            <a class="dropdown-item"
                                                               href="<?php echo admin_url('admin.php?page=easyjobs-admin&job-id=' . $job->id . '&view=candidates'); ?>"><?php _e('Candidates', 'easyjobs'); ?></a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <td colspan="5">
                                                <div class="alert alert-danger text-center m-0" role="alert">
                                                    ...
                                                    if (!empty($no_result_messages) && !empty($no_result_messages['published'])) {
                                                        ...
                                                        _e('No published jobs found', 'easyjobs');
                                                    }
                                                    ?>
                                                </div>
                                            </td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item"
                                                               ...
                                                               target="_blank"><?php _e('Preview', 'easyjobs'); ?></a>
                                                            <a class="dropdown-item"
                                                               href="<?php echo admin_url('admin.php?page=easyjobs-all-jobs&job-id=' . $job->id . '&view=pipeline'); ?>"><?php _e('Pipeline', 'easyjobs'); ?></a>
                                                            <a class="dropdown-item"
                                                               href="<?php echo admin_url('admin.php?page=easyjobs-all-jobs&job-id=' . $job->id . '&view=candidates'); ?>"><?php _e('Candidates', 'easyjobs'); ?></a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <td colspan="5">
                                                <div class="alert alert-danger text-center m-0" role="alert">
                                                    ...
                                                    if (!empty($no_result_messages) && !empty($no_result_messages['draft'])) {
                                                        ...
                                                        _e('No Draft jobs found', 'easyjobs');
                                                    }
                                                    ?>
                                                </div>
                                            </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item"
                                                               href="#"><?php _e('Preview', 'easyjobs'); ?></a>
                                                            <a class="dropdown-item"
                                                               href="<?php echo admin_url('admin.php?page=easyjobs-all-jobs&job-id=' . $job->id . '&view=pipeline'); ?>"><?php _e('Pipeline', 'easyjobs'); ?></a>
                                                            <a class="dropdown-item"
                                                               href="<?php echo admin_url('admin.php?page=easyjobs-all-jobs&job-id=' . $job->id . '&view=candidates'); ?>"><?php _e('Candidates', 'easyjobs'); ?></a>
                                            ...
                                            <td colspan="5">
                                                <div class="alert alert-danger text-center m-0" role="alert">
                                                    ...
                                                    if (!empty($no_result_messages) && !empty($no_result_messages['archived'])) {
                                                        ...
                                                        _e('No archived jobs found', 'easyjobs');
                                                    }
                                                    ?>
                                                </div>
                                            </td>
