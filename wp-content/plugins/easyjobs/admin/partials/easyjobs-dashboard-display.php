            ...
            <div class="content-area__body">
                ...
                <section class="counter-box section-gap">
                    <div class="row row-cols-md-4">
                        <div class="col">
                            <a href="<?php echo admin_url('admin.php?page=easyjobs-candidates');?>" class="counter__card">
                                ...
                                <div class="counter__card__text">
                                    ...
                                    <p><?php _e('Active Candidates', 'easyjobs')?></p>
                                </div>
                            </a>
                        </div>
                        <div class="col">
                            <a href="<?php echo admin_url('admin.php?page=easyjobs-all-jobs');?>" class="counter__card">
                                ...
                                <div class="counter__card__text">
                                    ...
                                    <p><?php _e('Active Jobs', 'easyjobs');?></p>
                                </div>
                            </a>
                        </div>
                        <div class="col">
                            <a href="<?php echo admin_url('admin.php?page=easyjobs-all-jobs&tab=draft');?>" class="counter__card">
                                <div class="counter__card__icon gradient-warning">
                                    <i class="eicon e-briefcase"></i>
                                </div>
                                <div class="counter__card__text">
                                    <h4><?php echo !empty($company_stats->draft_jobs) ? $company_stats->draft_jobs : 0; ?></h4>
                                    <p><?php _e('Draft Jobs', 'easyjobs')?></p>
                                </div>
                            </a>
                        </div>
                        <div class="col">
                            <a href="<?php echo EASYJOBS_APP_URL . '/company/setting/user'?>" class="counter__card" target="_blank">
                                ...
                                <div class="counter__card__text">
                                    ...
                                    <p><?php _e('Team Member', 'easyjobs');?></p>
                                </div>
                            </a>
                        </div>
                    </div>
                ...
                <section class="user-list section-gap">
                    <div class="section-title-wrap">
                        <h2 class="section-title"><?php _e('Recent Applications', 'easyjobs');?></h2>
                    </div>
                        ...
                        <div class="table">
                            ...
                            <div class="table__row">
                                ...
                                <div class="table-cell job__status">
                                    ...
                                    <span class="success-label"><?php _e('Active', 'easyjobs'); ?></span>
                                    <?php else: ?>
                                    <span class="danger-label"><?php _e('Expired', 'easyjobs'); ?></span>
                                    <?php endif?>
                                </div>
