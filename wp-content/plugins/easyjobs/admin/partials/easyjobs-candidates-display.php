                ...
                <section class="candidates-section section-gap">
                    <div class="d-flex flex-wrap align-items-start justify-content-between">
                        <div class="back-button mt-0">
                            ...
                            <div class="back-button__text d-none d-md-block"><?php _e('Back To Jobs', 'easyjobs');?></div>
                        </div>
                        <div class="dropdown ej-job-candidates-action ml-auto mr-3">
                            <button class="button info-button dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php _e('More', 'easyjobs');?></button>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#ej-invite-candidate-modal"><?php _e('Invite candidates', 'easyjobs');?></a>
                                <a class="dropdown-item" href="<?php echo admin_url('admin.php?page=easyjobs-admin&job-id=' . $_GET['job-id']  . '&view=pipeline');?>"><?php _e('Pipeline', 'easyjobs');?></a>
                                <a class="dropdown-item ej-export-candidates" href="#"><?php _e('Export', 'easyjobs');?></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex ej-candidate-search-filter align-items-center">
                            <div class="ej-job-candidate-filter">
                                <div class="select-option">
                                    <select>
                                        <option value="select" selected><?php _e('Sort candidates', 'easyjobs')?></option>
                                        <?php foreach (Easyjobs_Helper::candidateSortOptions() as $sortOption): ?>
                                            <option value="<?php echo $sortOption['value']?>"><?php _e($sortOption['title'], 'easyjobs')?></option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="candidates-filter-box easyjobs-filter">
                            <div class="filter-card">
                                <div class="filter-card__heading gutter-10">
                                    <div class="section-title"><?php _e('Filter', 'easyjobs'); ?></div>
                                </div>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <label class="checkbox">
                                                ...
                                                <span><?php _e('Rated', 'easyjobs');?></span>
                                            </label>
                                        </li>
                                        <li>
                                            <label class="checkbox">
                                                ...
                                                <span><?php _e('Not rated', 'easyjobs');?></span>
                                            </label>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="filter-card">
                                <div class="filter-card__heading gutter-10">
                                    <div class="section-title">
                                        <?php _e('Filter By Stage', 'easyjobs');?>
                                    </div>
                                </div>
                                <div class="filter-card__body gutter-10">
                                    <ul>
                                ...
                                <div class="table">
                                    <?php if(!empty($candidates)): ?>
                                        <div class="table__row table__head">
                                            <div class="table-cell"><?php _e('Name', 'easyjobs');?></div>
                                            <?php if($ai_enabled) : ?>
                                            <div class="table-cell"><?php _e('Score', 'easyjobs');?></div>
                                            <?php endif; ?>
                                            <div class="table-cell candidate-apply-time"><?php _e('Date',
                                                    'easyjobs');?></div>
                                            <div class="table-cell"><?php _e('Stage', 'easyjobs');?></div>
                                            <div class="table-cell"><?php _e('Rating', 'easyjobs');?></div>
                                        </div>
                                    ...
                                    <?php else: ?>
                                        <div class="table__row table__head">
                                            <div class="table-cell">
                                                <?php _e('No candidates found', 'easyjobs');?>
                                            </div>
                                        </div>
                                    <?php endif;?>
                                </div>
