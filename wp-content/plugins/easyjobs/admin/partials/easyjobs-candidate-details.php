<div class="wrap">
    ...
    <?php if(!empty($data)):?>
        <div class="easy-page-body">
            <input type="hidden" name="job_id" class="ej-job-id" value="<?php echo $data->candidate->job_id;?>">
                    ...
                    <section class="applicant-details">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="back-button mt-0">
                                <a href="<?php echo admin_url('admin.php?page=easyjobs-candidates');?>" class="back-button__icon">
                        ...
                        <div class="row">
                                ...
                                <div class="user-card align-items-baseline gutter-10">
                                    <ul class="user-info user-info__list">
                                        <li>
                                            ...
                                            <div class="user-text">
                                                <p class="user-text__label"><?php _e('First Name', 'easyjobs');?>*</p>
                                        ...
                                        <li>
                                            ...
                                            <div class="user-text">
                                                <p class="user-text__label"><?php _e('Last Name', 'easyjobs');?>*</p>
                                        ...
                                        <li>
                                            ...
                                            <div class="user-text">
                                                <p class="user-text__label"><?php _e('Email Address', 'easyjobs');?>*</p>
                                        ...
                                        <li>
                                            ...
                                            <div class="user-text">
                                                <p class="user-text__label"><?php _e('Phone Number', 'easyjobs');?>*</p>
                                        ...
                                        <li>
                                            ...
                                            <div class="user-text">
                                                <p class="user-text__label"><?php _e('Date of Application', 'easyjobs');?></p>
                                        ...
                                        <li>
                                            ...
                                            <div class="user-text">
                                                <p class="user-text__label"><?php _e('Rate', 'easyjobs');?>*</p>
                                        ...
                                        <li>
                                            ...
                                            <div class="user-text">
                                                <p class="user-text__label"><?php _e('Social Profile', 'easyjobs');?>*</p>
                                                <div class="mt-2">
                            ...
                            <div class="col-xl-6 pr-0">
                                <div class="tab__card tab__card--primary gutter-10 nav-tabs candidate-tabs">
                                    <a class="tab__control active nav-link" data-toggle="tab" href="#application" role="tab" aria-controls="application" aria-selected="true">
                                        ...
                                        <div class="tab__control__text"><?php _e('Application', 'easyjobs');?></div>
                                    </a>
                                    <a class="tab__control nav-link" data-toggle="tab" href="#resume" role="tab" aria-controls="resume" aria-selected="false">
                                        ...
                                        <div class="tab__control__text"><?php _e('Resume', 'easyjobs');?></div>
                                    </a>
                                    <a class="tab__control nav-link" data-toggle="tab" href="#evaluation" role="tab" aria-controls="evaluation" aria-selected="false">
                                        ...
                                        <div class="tab__control__text"><?php _e('Evaluation', 'easyjobs');?></div>
                                    </a>
                                </div>
                                    ...
                                    <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application">
                                        <div class="details__card gutter-10">
                                            <div class="details__card__head">
                                                <h4><?php _e('Cover Letter', 'easyjobs');?></h4>
                                            </div>
                                            <div class="details__card__body">
                                                ...
                                                <?php else: ?>
                                                    <div class="label__full  label__full--primary list-item--primary">
                                                        <?php _e('No cover letter', 'easyjobs'); ?>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="details__card gutter-10">
                                            <div class="details__card__head">
                                                <h4><?php _e('EXPERIENCE', 'easyjobs');?></h4>
                                                <p><?php _e('Total Year Of Experience: ', 'easyjobs');?> <span>( <?php echo $data->candidate->user->experience; ?> <?php _e(' Years', 'easyjobs');?> )</span></p>
                                            </div>
                                            <div class="details__card__body">
                                                <ul class="info__list">
                                                    ...
                                                    <?php else: ?>
                                                        <li class="label__full  label__full--primary list-item--primary">
                                                            <?php _e('No job experience', 'easyjobs'); ?>
                                                        </li>
                                                    <?php endif; ?>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="details__card gutter-10">
                                            <div class="details__card__head">
                                                <h4><?php _e('EDUCATIONAL QUALIFICATION', 'easyjobs');?></h4>
                                            </div>
                                            <div class="details__card__body">
                                                <ul class="info__list">
                                                    ...
                                                    <?php else: ?>
                                                        <li class="label__full  label__full--primary list-item--primary">
                                                            <?php _e('No educational qualification', 'easyjobs'); ?>
                                                        </li>
                                                    <?php endif; ?>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="evaluation" role="tabpanel" aria-labelledby="evaluation">
                                        <div class="candidate-details-tab__body">
                                            ...
                                            <div class="candidate-details-tab__body gutter-10">
                                                <div class="details__card gutter-10">
                                                    <div class="details__card__head">
                                                        <h4><?php _e('AI Score', 'easyjobs');?></h4>
                                                    </div>
                                                    <div class="details__card__body">
                                                        <div class="d-flex justify-content-between flex-wrap">
                                                            <div class="text-center" style="position: relative;">
                                                                <p><?php _e('Skills', 'easyjobs');?></p>
                                            ...
                                            <div class="details__card gutter-10">
                                                <div class="details__card__head nav nav-pills" id="myTab" role="tablist">
                                                    ...
                                                    <a class="tab--toggler" id="screening-question-tab" data-toggle="tab" href="#screening-question" role="tab" aria-controls="screening-question" aria-selected="false">
                                                        <?php _e('Screening Question', 'easyjobs'); ?>
                                                    </a>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane fade show active" id="quiz" role="tabpanel" aria-labelledby="quiz-tab">
                                                        ...
                                                        <div class="details__card__body">
                                                            <ul class="info__list question-answer">
                                                                ...
                                                                <li class="list-item--primary">
                                                                    <p class="question"><strong><?php _e('Question-' . ($k+1) . ': ', 'easyjobs');?></strong><?php echo $q->asked;?></p>
                                                    ...
                                                    <div class="tab-pane fade" id="screening-question" role="tabpanel" aria-labelledby="screening-question-tab">
                                                        ...
                                                        <div class="details__card__body">
                                                            <ul class="info__list question-answer">
                                                                ...
                                                                <li class="list-item--primary">
                                                                    <p class="question"><strong><?php _e('Question-' . ($key+1) . ': ', 'easyjobs');?></strong><?php echo $question->asked; ?></p>
                                                                    <p class="label__full--modified label__full--primary answer">
                                                                        <span class="ans-label">Ans : </span>
                            ...
                            <div class="col-xl-3 d-flex flex-column">
                                <div class="details__card gutter-10">
                                    <div class="details__card__head">
                                        <h4><?php _e('Salary', 'easyjobs');?></h4>
                                    </div>
                                    <div class="details__card__body">
                                        <ul class="info__list">
                                            <li class="label__full  label__full--primary list-item--primary">
                                                <p><?php _e('Current Salary', 'easyjobs');?></p>
                                                <p class="label__content"><?php echo $data->candidate->user->current_salary; ?></p>
                                            </li>
                                            <li class="label__full  label__full--primary list-item--primary">
                                                <p><?php _e('Expected Salary', 'easyjobs');?></p>
                                ...
                                <div class="details__card gutter-10 ej-candidate-notes-from">
                                    ...
                                    <div class="details__card__body">
                                        <form class="ej-add-note" data-candidate-id="<?php echo $_GET['candidate-id'];?>">
                                            <textarea name="note" id="" rows="5" placeholder="Add a note here . . . " class="label__full--primary form-control"></textarea>
                                            ...
                                            <div class="tag-select mt-2">
                                                <select name="tag_select" id="tag-select" multiple>
                                                    ...
                                                    <option value='<?php echo json_encode($manager)?>'>
                                ...
                                <div class="details__card gutter-10 ej-candidate-notes">
                                    <div class="details__card__body">
                                        ...
                                        <div class="note-info" data-note-id="<?php echo $note->id; ?>">
