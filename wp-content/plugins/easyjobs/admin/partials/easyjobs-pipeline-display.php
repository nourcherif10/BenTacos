                        ...
                        <section class="pipeline-section">
                            <div class="d-flex justify-content-between my-5">
                                ...
                                <div class="dropdown pipeline-action ml-auto mr-3 d-none d-md-block">
                                    <button class="button white-button dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php _e('Job Menu', 'easyjobs');?></button>
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="<?php echo admin_url('admin.php?page=easyjobs-all-jobs');?>"><?php _e('All jobs', 'easyjobs');?></a>
                                        <a class="dropdown-item" href="<?php echo admin_url('admin.php?page=easyjobs-admin&job-id=' . $job->id . '&view=candidates'); ?>"><?php _e('Candidates', 'easyjobs');?></a>
                                    </div>
                                </div>
                                <button class="edit-button d-none d-md-flex mr-3" data-toggle="modal" data-target="#pipeline-modal">
                                    ...
                                    <span> <?php _e('Edit Pipeline', 'easyjobs');?> </span>
                                </button>
                                                                ...
                                                                <div class="pipeline-card">
                                                                    ...
                                                                    <div class="user__details">
                                                                        ...
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <p class="user__experience"> <?php echo $applicant->user->experience; ?> <?php _e('Years', 'easyjobs');?></p>
                                                                        </div>
