            ...
            <div class="content-area__body">
                ...
                <section class="published-jobs section-gap">
                    ...
                    <div class="tab-content ej-tab-content">
                        <div class="tab-pane fade <?php echo $active_tab === 'published' ? 'active show': '';?>" id="published-jobs" role="tabpanel" aria-labelledby="published-jobs">
                                            ...
                                            <div class="card-content">
                                                <div class="card-content__left">
                                                    ...
                                                    <div class="card-info-group">
                                                        <p class="card-info">
                                                            <?php _e('Post Date: ', 'easyjobs')?>  <?php echo $job->created_at?>
                                                        </p>
                                                        <p class="card-info">
                                                          <?php _e('Expiry Date: ', 'easyjobs')?>  <?php echo $job->expire_at?>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="card-content__right">
                                                    <p><?php echo $job->applicant_count; ?> <?php _e('Applied', 'easyjobs')?></p>
                            ...
                            <?php else: ?>
                                <h4 class="empty-message">
                                    <?php _e('No jobs found.', 'easyjobs');?>
                                </h4>
                            <?php endif;?>
                        </div>
                        <div class="tab-pane fade <?php echo $active_tab === 'archive' ? 'active show': '';?>" id="archive-jobs" role="tabpanel" aria-labelledby="archive-jobs">
                            <div class="section-title-wrap">
                                <h2 class="section-title">
                        ...
                        <div class="tab-pane fade <?php echo $active_tab === 'draft' ? 'active show': '';?>" id="draft-jobs" role="tabpanel" aria-labelledby="draft-jobs">
                            <div class="section-title-wrap">
                                <h2 class="section-title">
