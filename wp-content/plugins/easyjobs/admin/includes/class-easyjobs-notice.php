...
class WPDeveloper_Notice {
    ...
    public function hooks(){
        ...
        // if( current_user_can( 'install_plugins' ) ) {
            if( isset( $_GET['plugin'] ) &&  $_GET['plugin'] == $this->plugin_name && isset( $_GET['tab'] ) &&  $_GET['tab'] !== 'plugin-information') {
    ...
    private function upsale_button(){
        ...
        $btn_text = ( isset( $upsale_args['btn_text'] )) ? $upsale_args['btn_text'] : __( 'Install Now!', 'easyjobs' ) ;
