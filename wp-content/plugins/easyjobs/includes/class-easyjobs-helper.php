...
class Easyjobs_Helper {
    ...
    public static function subscription_data_html($data, $text) {
        if ($data) {
            echo __($text, 'easyjobs');
        } else {
            echo '<del>' . __($text, 'easyjobs') . '</del>';
        }
    }
    ...
    public static function get_job_status_badge($status)
    {
        switch ($status){
            case 1:
                return '<div class="thumbnail__status thumbnail__status--warning">' . __('Draft', 'easyjobs') . '</div>';
            case 2:
                return '<div class="thumbnail__status thumbnail__status--success">' . __('Active', 'easyjobs') . '</div>';
            case 3:
                return '<div class="thumbnail__status thumbnail__status--info">' . __('Archived', 'easyjobs') . '</div>';
            case 4:
                return '<div class="thumbnail__status thumbnail__status--danger">' . __('Deleted', 'easyjobs') . '</div>';
            case 10:
                return '<div class="thumbnail__status thumbnail__status--success">' . __('Republished', 'easyjobs') . '</div>';
            default:
                return '<div class="thumbnail__status thumbnail__status--success">' . __('Active', 'easyjobs') . '</div>';
    ...
    {
        $errors = [];
        if(!Easyjobs_Helper::is_iterable($error_messages)){
            return [
    ...
    public static function get_success_response($message, $data=[])
    {
        return json_encode([
            'status' => 'success',
            'message' => $message,
