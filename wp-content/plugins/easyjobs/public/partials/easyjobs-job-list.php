                    ...
                    <div class="ej-job-list-item-inner">
                        <div class="ej-job-list-item-col">
                            ...
                            <div class="ej-job-list-info">
                                ...
                                <div class="ej-job-list-info-block">
                                    ...
                                    <span><?php _e('Anywhere (Remote)', 'easyjobs'); ?></span>
                                    <?php else: ?>
                                    <span>
                        ...
                        <div class="ej-job-list-item-col">
                            ...
                            if (!$job->is_expired):
                                ...
                                <p class="ej-list-sub">
                                    <?php _e('No of vacancies: ', 'easyjobs'); ?> <?php echo $job->vacancies; ?>
                                </p>
                            <?php else: ?>
                        ...
                        <div class="ej-job-list-item-col">
                            <a href="<?php echo !empty($job->apply_url) ? $job->apply_url : '#';?>" class="ej-btn ej-info-btn-light" target="_blank">
                                <?php _e('Apply', 'easyjobs'); ?>
                            </a>
                        </div>
                    </div>
                </div>
...
<?php else: ?>
    <h3>
        <?php _e('No open jobs right now', 'easyjobs' ); ?>
    </h3>
<?php endif; ?>
