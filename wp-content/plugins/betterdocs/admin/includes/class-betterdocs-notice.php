...
if( ! class_exists( 'Betterdocs_Pro' ) ) {
    ...
    $notice->message( 'update_10kuser', '<p>'. __( 'Join us to celebrate 20,000+ happy users of BetterDocs & get exclusive <strong>30% OFF</strong> with coupon code <em><strong>‘BD30’</strong></em> while upgrading to PRO. <a class="button button-small" href="https://betterdocs.co/get/betterdocs-20k" target="_blank">Upgrade to PRO</a> ', $notice->text_domain ) .'</p>' );
